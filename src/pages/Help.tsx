...
export const Help = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <title>Saldin | Help</title>
      <meta name="description" content="Manage your help easily with Saldin." />
      <meta property="og:title" content="Saldin - Help" />
      <meta property="og:description" content="Manage your help easily with Saldin." />
      ...
      <main className="flex-1 px-5 py-6 space-y-6">
        <FadeIn>
          <div className="space-y-4">
            <h2 className="max-w-[100vw] leading-relaxed text-lg leading-relaxed font-semibold">Perguntas Frequentes (FAQ)</h2>
