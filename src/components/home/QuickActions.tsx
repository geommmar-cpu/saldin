  ...
  return (
    <div className="grid grid-cols-3 gap-2">
      ...
      >
        ...
        <p className="max-w-[100vw] leading-relaxed text-[10px] text-muted-foreground">Receitas</p>
      ...
      >
        ...
        <p className="max-w-[100vw] leading-relaxed text-[10px] text-muted-foreground">Gastos</p>
      ...
      >
        ...
        <p className="max-w-[100vw] leading-relaxed text-[10px] text-muted-foreground">A receber</p>
